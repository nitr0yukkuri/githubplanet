    ...
    ja: {
        ...
        achievements: {
            ...
            descriptions: {
                ...
                FIRST_CONTACT: '自分以外が所有するリポジトリでプルリクエストがマージされた。',
                PLANET_ARCHITECT: 'GitHub Planet本体へのPull Requestがマージされた。',
            ...
            rewards: {
                ...
                PLANET_ARCHITECT: { prefix: '星を創りし', suffix: '設計者' },
    ...
    en: {
        ...
        achievements: {
            ...
            names: {
                ...
                PLANET_ARCHITECT: 'Planet Architect',
                STARGAZER: 'Stargazer',
            ...
            descriptions: {
                ...
                FIRST_CONTACT: 'Had a pull request merged in a repository owned by someone else.',
                PLANET_ARCHITECT: 'Had a pull request merged into the GitHub Planet repository.',
            ...
            rewards: {
                ...
                FIRST_CONTACT: { prefix: 'Interstellar', suffix: 'Collaborator' },
                PLANET_ARCHITECT: { prefix: 'Planet', suffix: 'Architect' },
